SELECT DISTINCT
    ...
    ea.[primary] as PRIMARY_BOOL
FROM
    [psu110buncombe].[dbo].[staffMember] sm
    JOIN [psu110buncombe].[dbo].[EmploymentAssignment] ea ON sm.personID=ea.personID AND sm.assignmentID=ea.assignmentID
WHERE 1=1
