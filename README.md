...
Hanging issues:
1. need to figure out where to pull student emails
2. what do to about alias ID
3. where to pull PSU name and school name
4. where / how to pull multivalued teacher UID list