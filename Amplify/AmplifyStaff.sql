...
and exists(select 1
			...
			and (
				LEFT(crs.stateCode,4) IN('1050','1051','1052','1053','1054') -- "regular" K-4 ELA for all (4 for RRET)
				or crs.stateCode IN('11512Z0','11512Z1','11512Z2','11512Z3') -- "DL/I" K-3 ELA for all
				or (psu_type.charter is null and LEFT(crs.stateCode,4) IN('1055')) -- "regular" 5 ELA for LEAs
