...
This bookmarklet will update or clear the saved Student and Staff UID values for a person in Infinite Campus. This only works in Firefox (or Firefox derivatives).

To use this script:
1) Copy the line below beginning with "javascript".
2) Create a new bookmark in Firefox. Paste the line below as the URL / location.
...
4) Click the bookmarklet from the Bookmarks menu or toolbar. Input the Student UID value to insert (or click OK for blank). Input the Staff UID value to insert (or click OK for blank).
*/
